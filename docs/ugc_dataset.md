...
| 模块 | 做法 | 依据 / 标定 |
|---|---|---|
| 裁剪 | 有人脸时脸放在水平中线、画面上 1/3（自拍构图）；没有人脸时选纹理最多的位置 | YuNet 人脸检测 |
...
| | 我们 | 真实 |
|---|---|---|
| 画幅 | 4:5 30%、16:9 27%、1:1 23%、9:16 20% | 9:16 92–100% |
| 每 10 秒切换 | 中位数 4.0 | TikTok 3.4、Meta 4.1 |
| 主题 | 美妆 20%、家居 16%、科技 14%、服饰 12%、美食 8%、宠物 7% | 20 / 16 / 16 / 14 / 9 / 8% |
| 录屏 / 文字卡片占画面 | 0.9% / 3.8% | 3.2% / 6.6% |
| 用到的不同片段 / YouTube 源 | 192 / 151 | — |

- 主题和剪辑节奏对上了；竖屏严重不足（4K 横屏裁不出 1440x2560，8K 全池只有约 230 条）。
...
- **成品复核发现的问题**（第 6 节末）：手机色彩过头、感知质量上退化偏重、竖屏和人脸不足、素材源少。
